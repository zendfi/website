  ...
  return (
    <section id="features" className="py-32 px-6 relative overflow-hidden">
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/4 right-0 w-1/2 h-96 bg-violet-700/5 blur-[120px]" />
      </div>
        ...
        >
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-50 border border-violet-200 mb-5">
              <span className="text-xs font-medium text-violet-600 tracking-wide">Platform features</span>
            </div>
            <h2 className="text-[clamp(32px,4.5vw,52px)] font-extrabold text-gray-900 leading-tight tracking-tight">
              Everything you need
              <br />
              to <span className="text-violet-600">move money on-chain.</span>
            </h2>
          </div>

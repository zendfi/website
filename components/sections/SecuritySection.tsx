...
const pillars = [
  ...
  {
    icon: <KeyRound size={20} color="#60a5fa" />,
    title: 'Passkey Login',
    ...
    <section ref={ref} className="py-36 px-6 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-violet-50 border border-violet-200 mb-8">
              <span className="text-xs font-medium text-violet-600 tracking-wide">Security</span>
            </div>

            <blockquote className="text-[clamp(32px,4.5vw,54px)] font-extrabold text-gray-900 leading-tight tracking-tight mb-6">
              &ldquo;Non-custodial
              <br />
              <span className="text-violet-600">by architecture.&rdquo;</span>
            </blockquote>
            ...
            <div className="mt-8 flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-gray-50 border border-gray-100 flex items-center justify-center text-base">◎</div>
              <div>
          ...
          <div className="flex flex-col gap-8">
            {pillars.map((p, i) => (
              ...
              >
                <div
                  className="w-10 h-10 rounded-xl border flex items-center justify-center text-base shrink-0 mt-0.5"
                  style={{ borderColor: `${p.color}20`, background: `${p.color}10` }}
                >
                  {p.icon}
                </div>
                <div>

                ...
                >
                    <div>
                        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gray-50 border border-gray-100 mb-4">
                            <span className="text-[10px] font-bold text-gray-600 tracking-widest uppercase">Pricing</span>
                        </div>
                ...
                <div className="rounded-3xl overflow-hidden border border-gray-100">
                    {rows.map((row, i) => (
                        <motion.div
                            ...
                            className={`flex flex-col sm:flex-row sm:items-center gap-4 sm:gap-8 px-7 py-6 border-b border-gray-100 last:border-0 transition-colors ${row.highlight
